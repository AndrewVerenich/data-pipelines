...
public final class BronzeToSilverJob {
  ...
  public static void main(String[] args) throws Exception {
    ...
    int waitSeconds = Integer.parseInt(parsed.getOrDefault("wait-seconds", "120"));
  ...
  private static void waitForPath(SparkSession spark, String sourcePath, int waitSeconds, int waitIntervalSeconds)
      throws Exception {
